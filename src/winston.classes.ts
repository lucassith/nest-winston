...
export class WinstonLogger implements LoggerService {
  ...
  public fatal(message: any, trace?: string | Error, context?: string): any {
    context = context || this.context;
    ...
    if (trace instanceof Error) {
      return this.logger.error(message, { context, error: trace.message, stack: [trace.stack] });
    }

    return this.logger.error({ level: 'fatal', message, context, stack: [trace] });
  }

  public error(message: any, trace?: string | Error, context?: string): any {
    context = context || this.context;
